...
* **5. Puppet install Nginx**
  * [7-puppet_install_nginx_web_server.pp](./7-puppet_install_nginx_web_server.pp): Bash script that configures a new Ubuntu machine with Nginx.
